...
function Frame10() {
  return (
    <div className="content-stretch flex font-['Montserrat:Regular',sans-serif] font-normal items-center relative shrink-0 w-full">
      <Frame9 />
      <p className="relative shrink-0 whitespace-pre">{`20  KM`}</p>
    </div>
  );
}
