...
function Frame6() {
  return <div className="h-[42px] relative shrink-0 w-full" />;
}
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="bg-white col-1 h-[139px] ml-0 mt-0 relative rounded-[13px] row-1 shadow-[0px_4px_18.9px_2px_rgba(0,0,0,0.25)] w-[162px]" />
      <div className="bg-white border border-[#bababa] border-solid col-1 h-[36px] ml-[21px] mt-[57px] relative rounded-bl-[13px] rounded-tl-[13px] row-1 w-[60px]" />
      <div className="col-1 flex h-[36px] items-center justify-center ml-[81px] mt-[57px] relative row-1 w-[60px]">
        <div className="flex-none rotate-180">
          <div className="bg-white border border-[#bababa] border-solid h-[36px] relative rounded-bl-[13px] rounded-tl-[13px] w-[60px]" />
        </div>
      </div>
