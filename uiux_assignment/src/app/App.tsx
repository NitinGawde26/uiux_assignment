import { Github, Linkedin, Mail, Phone, ExternalLink, Code2, BookOpen } from 'lucide-react';
...
export default function App() {
  ...
  const projects = [
    ...
    {
      title: "Touristo",
      description: "React Native app with AI-powered anomaly detection for tourist safety, featuring route deviation detection, geo-fencing, and blockchain-based verification.",
      image: "https://images.unsplash.com/photo-1717501219526-5cef0a447f76?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080",
      tags: ["React Native", "MongoDB", "Hyperledger", "LangChain"],
      link: "#"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-[#2d5a3d]">NG</span>
            </div>
              ...
              >
                <div className="relative overflow-hidden h-48">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#2d5a3d]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                    <a href={project.link} className="text-white flex items-center gap-2 font-semibold">
